...
public class perfilUsuario {
     ...
     * crear funcion main--
     * Escriba el código para que la aplicación almacene el nombre, la edad, el
     * género,
     * la preferencia laboral, la nacionalidad y el tipo de sangre de los usuarios.
     * Piense en los nombres de variables que desea asignar a las propiedades
     * anteriores y
    ...
    public static void main(String[] args) {
        ...
        // Se puede usar char pero tuve problematicas con la entrega de info por parte
        // de Java

        LocalDate anioActual = LocalDate.now();
        DateTimeFormatter formato = DateTimeFormatter.ofPattern("YYYY");
        int anioFormatter = Integer.parseInt(anioActual.format(formato));
        ...
        System.out.println("Su nombre es: " + nombre +
                ...
                "Su edad es : " + edadInt +
                "Su género es :" + genero +
                "Su género es :" + (anioFormatter - edadInt));
